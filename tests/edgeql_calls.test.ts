...
describe("TestEdgeQLFuncCalls", () => {
  ...
  it("test_edgeql_calls_01", () => {
    ...
    assertQueryResult(h, `SELECT call1('-');`, ["pref--0-suf"]);
    assertQueryResult(h, `SELECT call1('-', suffix := 's1');`, ["pref--0s1"]);
    assertQueryResult(h, `SELECT call1('-', prefix := 'p1');`, ["p1-0-suf"]);
    assertQueryResult(h, `SELECT call1('-', suffix := 's1', prefix := 'p1');`, ["p1-0s1"]);
    assertQueryResult(h, `SELECT call1('-', 1);`, ["pref--1-suf"]);
    assertQueryResult(h, `SELECT call1('-', 1, suffix := 's1');`, ["pref--1s1"]);
    assertQueryResult(h, `SELECT call1('-', 1, prefix := 'p1');`, ["p1-1-suf"]);
    assertQueryResult(h, `SELECT call1('-', 1, 2, 3, 4, 5);`, ["pref--15-suf"]);
    assertQueryResult(h, `SELECT call1('-', 1, 2, 3, 4, 5, suffix := 's1');`, ["pref--15s1"]);
    assertQueryResult(h, `SELECT call1('-', 1, 2, 3, 4, 5, prefix := 'p1');`, ["p1-15-suf"]);
    assertQueryResult(
      h,
      `
  ...
  it("test_edgeql_calls_02", () => {
    ...
    assertQueryResult(h, `SELECT call2('a', 'b');`, ["=2="]);
    assertQueryResult(h, `SELECT call2(4, 2, 0);`, ["=3="]);
  });
  ...
  it("test_edgeql_calls_03", () => {
    ...
    expect(() => {
      h.script(`SELECT call3(1);`);
    }).toThrow(new RegExp("function .+ does not exist"));
    expect(() => {
      h.script(`SELECT call3(1, 2);`);
    }).toThrow(new RegExp("function .+ does not exist"));
    expect(() => {
      h.script(`SELECT call3(1, 2, 3);`);
    }).toThrow(new RegExp("function .+ does not exist"));
    expect(() => {
      h.script(`SELECT call3(b := 1);`);
    }).toThrow(new RegExp("function .+ does not exist"));
    expect(() => {
      h.script(`SELECT call3(1, 2, b := 1);`);
    }).toThrow(new RegExp("function .+ does not exist"));
  });
  ...
  it("test_edgeql_calls_04", () => {
    ...
    assertQueryResult(h, `SELECT call4(100);`, [100]);
    assertQueryResult(h, `SELECT call4(100, b := <int32>[]);`, [100]);
    assertQueryResult(h, `SELECT call4(100, b := [1, 2]);`, [102]);
    assertQueryResult(h, `SELECT call4(100, b := ['a', 'b']);`, [102]);
  });
  ...
  it("test_edgeql_calls_05", () => {
    ...
    assertQueryResult(h, `SELECT call5(1);`, [-99]);
    assertQueryResult(h, `SELECT call5(<int32>2);`, [-98]);
    assertQueryResult(h, `SELECT call5(1, b := 20);`, [21]);
    assertQueryResult(h, `SELECT call5(1, b := <int16>10);`, [11]);
    assertQueryResult(h, `SELECT call5(<int32>{});`, []);
    assertQueryResult(h, `SELECT call5(<int32>{}, b := <int32>{});`, []);
    assertQueryResult(h, `SELECT call5(<int32>{}, b := 50);`, []);
    assertQueryResult(h, `SELECT call5(1, b := <int32>{});`, [-99]);
    assertQueryResult(
      h,
      `
  ...
  it("test_edgeql_calls_06", () => {
    ...
    assertQueryResult(h, `SELECT call6();`, [0]);
    assertQueryResult(h, `SELECT call6(1, 2, 3);`, [6]);
    assertQueryResult(h, `SELECT call6(<int16>1, <int32>2, 3);`, [6]);
  });
  ...
  it("test_edgeql_calls_07", () => {
    ...
    assertQueryResult(h, `SELECT call7();`, [[1, 2, 3, 4, 5]]);
    assertQueryResult(h, `SELECT call7(e := 100);`, [[1, 2, 3, 4, 100]]);
    assertQueryResult(h, `SELECT call7(d := 200);`, [[1, 2, 3, 200, 5]]);
    assertQueryResult(h, `SELECT call7(20, 30, d := 200);`, [[20, 30, 3, 200, 5]]);
    assertQueryResult(h, `SELECT call7(20, 30, e := 42, d := 200);`, [[20, 30, 3, 200, 42]]);
    assertQueryResult(h, `SELECT call7(20, 30, 1, d := 200, e := 42);`, [[20, 30, 1, 200, 42]]);
    expect(() => {
      h.script(
  ...
  it("test_edgeql_calls_08", () => {
    ...
    assertQueryResult(h, `SELECT call8(1);`, [3]);
    assertQueryResult(h, `SELECT call8(1.0);`, [1003]);
    assertQueryResult(h, `SELECT call8(1, b := 10);`, [11]);
    assertQueryResult(h, `SELECT call8(1.0, b := 10);`, [1011]);
    expect(() => {
      h.script(`SELECT call8();`);
    }).toThrow(new RegExp("function call8 is not unique"));
  });

  it("test_edgeql_calls_09", () => {
    assertQueryResult(h, `SELECT sum({1, 2, 3});`, unorderedSet([6]));
    assertQueryResult(h, `SELECT sum({<int32>1, 2, 3});`, unorderedSet([6]));
    assertQueryResult(h, `SELECT sum({<float32>1, 2, 3});`, unorderedSet([6]));
    assertQueryResult(h, `SELECT sum({<float32>1, <int32>2, 3});`, unorderedSet([6]));
    assertQueryResult(h, `SELECT sum({<int16>1, <int32>2, <decimal>3});`, unorderedSet([6]));
    assertQueryResult(h, `SELECT sum({1.1, 2.2, 3});`, unorderedSet([6.3]));
  });
  ...
  it("test_edgeql_calls_11", () => {
    ...
    assertQueryResult(h, `SELECT call11([<int16>1, <int16>22]);`, [23]);
    assertQueryResult(h, `SELECT call11([<int16>1, <int32>23]);`, [24]);
    assertQueryResult(h, `SELECT call11([<int32>1, <int32>24]);`, [25]);
    expect(() => {
      h.script(`SELECT call11([<int32>1, 1.1]);`);
    }).toThrow(new RegExp("function .+ does not exist"));
    expect(() => {
      h.script(`SELECT call11([<int32>1, <float32>1]);`);
    }).toThrow(new RegExp("function .+ does not exist"));
    expect(() => {
      h.script(`SELECT call11([1, 2]);`);
    }).toThrow(new RegExp("function .+ does not exist"));
  });
  ...
  it("test_edgeql_calls_12", () => {
    ...
    assertQueryResult(h, `SELECT call12(<int32>1);`, [101]);
    assertQueryResult(h, `SELECT call12(1);`, [2]);
  });
  ...
  it("test_edgeql_calls_13", () => {
    ...
    assertQueryResult(h, `SELECT call13('aaa');`, [1]);
    assertQueryResult(h, `SELECT call13(b'aaaa');`, [1]);
    assertQueryResult(h, `SELECT call13([1, 2, 3, 4, 5]);`, [1]);
    assertQueryResult(h, `SELECT call13(['a', 'b']);`, [1]);
    h.script(
      `
            CREATE FUNCTION inner(
                a: str
    ...
    assertQueryResult(h, `SELECT call13_2('aaa');`, [2]);
    assertQueryResult(h, `SELECT call13_2(b'aaaa');`, [1]);
    assertQueryResult(h, `SELECT call13_2([1, 2, 3, 4, 5]);`, [1]);
    assertQueryResult(h, `SELECT call13_2(['a', 'b']);`, [1]);
  });
  ...
  it("test_edgeql_calls_13_sdl", () => {
    ...
    assertQueryResult(h, `SELECT call13_sdl(1.0)`, ["anytype"]);
    assertQueryResult(h, `SELECT call13_sdl(1)`, ["int64"]);
  });
  ...
  it("test_edgeql_calls_14", () => {
    ...
    assertQueryResult(h, `SELECT call14('aaa');`, [["aaa"]]);
    expect(h.query("SELECT call14(b'aaaa');")).toEqual([[new Uint8Array([97, 97, 97, 97])]]);
    assertQueryResult(h, `SELECT call14(1);`, [[1]]);
  });
  ...
  it("test_edgeql_calls_15", () => {
    ...
    assertQueryResult(h, `SELECT call15('aaa');`, [["aaa", "aaa", "aaa"]]);
    assertQueryResult(h, `SELECT call15(1);`, [[1, 1, 1]]);
  });
  ...
  it("test_edgeql_calls_16", () => {
    ...
    assertQueryResult(h, `SELECT call16([1, 2, 3], 1);`, [2]);
    assertQueryResult(h, `SELECT call16(['a', 'b', 'c'], 1);`, ["b"]);
    assertQueryResult(h, `SELECT call16([1, 2, 3], '1');`, [3]);
    assertQueryResult(h, `SELECT call16(['a', 'b', 'c'], '1');`, ["c"]);
    assertQueryResult(h, `SELECT call16('xyz', 1);`, ["y"]);
  });
  ...
  it("test_edgeql_calls_17", () => {
    ...
    assertQueryResult(h, `SELECT call17(2);`, [[2, 2, 2]]);
    assertQueryResult(h, `SELECT call17('aaa');`, [["!!!!", "aaa", "!!!!"]]);
  });
  ...
  it("test_edgeql_calls_18", () => {
    ...
    assertQueryResult(h, `SELECT call18(2);`, [1]);
    assertQueryResult(h, `SELECT call18(1, 2, 3);`, [3]);
    assertQueryResult(h, `SELECT call18('a', 'b');`, [2]);
    expect(() => {
      h.script(`SELECT call18(1, 2, "a");`);
    }).toThrow(new RegExp("function .+ does not exist"));
  });
  ...
  it("test_edgeql_calls_19", () => {
    ...
    h.script(`SELECT call19((1,2));`);
    h.script(`SELECT call19((1,));`);
  });
  ...
  it("test_edgeql_calls_20 [xerror: Polymorphic callable matching is currently too dumb to realize that `+` _is_ defined for 'anyreal', even though there are multiple actual forms defined.]", () => {
    ...
    assertQueryResult(h, `SELECT call20_1(10, 20);`, [30]);
    assertQueryResult(h, `SELECT call20_2(1, 2);`, [true]);
    assertQueryResult(h, `SELECT call20_2('b', 'a');`, [false]);
    expect(() => {
      h.script(`SELECT call20_1(1, "1");`);
    }).toThrow(new RegExp("function .+ does not exist"));
  });
  ...
  it("test_edgeql_calls_21", () => {
    ...
    assertQueryResult(h, `SELECT call21(<array<str>>[]);`, [0]);
    assertQueryResult(h, `SELECT call21([1,2]);`, [2]);
    assertQueryResult(h, `SELECT call21(['a', 'b', 'c']);`, [3]);
    assertQueryResult(h, `SELECT call21([(1, 2), (2, 3), (3, 4), (4, 5)]);`, [4]);
  });
  ...
  it("test_edgeql_calls_22", () => {
    ...
    assertQueryResult(h, `SELECT call22('a', 'b');`, ["ab"]);
    assertQueryResult(h, `SELECT call22(['a'], ['b']);`, [["a", "b"]]);
  });
  ...
  it("test_edgeql_calls_23", () => {
    ...
    assertQueryResult(h, `SELECT call23('abcde', 2);`, ["c"]);
    assertQueryResult(h, `SELECT call23('abcde', <int32>2);`, ["de"]);
  ...
  it("test_edgeql_calls_24", () => {
    ...
    assertQueryResult(h, `select call24();`, ["abcd"]);
    assertQueryResult(h, `select call24('aaa');`, ["aaa!"]);
  });
  ...
  it("test_edgeql_calls_26", () => {
    ...
    assertQueryResult(h, `SELECT call26(['aaa']);`, [1]);
    assertQueryResult(h, `SELECT call26([b'', b'aa']);`, [2]);
    expect(() => {
      h.script(`SELECT call26([(1, 2)]);`);
    }).toThrow(new RegExp("function .+ does not exist"));
  });
  ...
  it("test_edgeql_calls_27", () => {
    ...
    assertQueryResult(h, `SELECT call27([<int32>1, <int32>2]);`, [2]);
    assertQueryResult(h, `SELECT call27([1, 2, 3]);`, [3]);
    expect(() => {
      h.script(`SELECT call27(['aaa']);`);
    }).toThrow(new RegExp("function .+ does not exist"));
    expect(() => {
      h.script(`SELECT call27([b'', b'aa']);`);
    }).toThrow(new RegExp("function .+ does not exist"));
    expect(() => {
      h.script(`SELECT call27([1.0, 2.1]);`);
    }).toThrow(new RegExp("function .+ does not exist"));
    expect(() => {
      h.script(`SELECT call27([('a',), ('b',)]);`);
    }).toThrow(new RegExp("function .+ does not exist"));
  });
  ...
  it("test_edgeql_calls_28", () => {
    ...
    assertQueryResult(h, `SELECT call28([<int32>1, <int32>2]);`, [2]);
    assertQueryResult(h, `SELECT call28([1, 2, 3]);`, [3]);
    assertQueryResult(h, `SELECT call28(['a', 'b']);`, [1002]);
  });
  ...
  it("test_edgeql_calls_29", () => {
    ...
    assertQueryResult(h, `SELECT call29(10);`, [11]);
  });
  ...
  it("test_edgeql_calls_30", () => {
    ...
    assertQueryResult(h, `SELECT call30(10);`, [110]);
    assertQueryResult(h, `SELECT call30(<int32>20);`, [120]);
  });
  ...
  it("test_edgeql_calls_31", () => {
    ...
    assertQueryResult(h, `SELECT call31(10);`, [10]);
    assertQueryResult(h, `SELECT call31('aa');`, ["aa"]);
    assertQueryResult(h, `SELECT call31([1, 2]);`, [[1, 2]]);
    assertQueryResult(h, `SELECT call31([1, 2])[0];`, [1]);
    assertQueryResult(h, `SELECT call31((a:=1001, b:=1002)).a;`, [1001]);
    assertQueryResult(h, `SELECT call31((a:=1001, b:=1002)).1;`, [1002]);
    assertQueryResult(h, `SELECT call31((a:=['a', 'b'], b:=['x', 'y'])).1;`, [["x", "y"]]);
    assertQueryResult(h, `SELECT call31((a:=['a', 'b'], b:=['x', 'y'])).a[1];`, ["b"]);
    assertQueryResult(h, `SELECT call31((a:=1001, b:=1002));`, [
      {
        a: 1001,
        b: 1002,
      },
    ]);
    assertQueryResult(h, `SELECT call31((a:=[(x:=1)])).a[0].x;`, [1]);
    assertQueryResult(h, `SELECT call31((a:=[(x:=1)])).0[0].x;`, [1]);
    assertQueryResult(h, `SELECT call31((a:=[(x:=1)])).0[0].0;`, [1]);
    assertQueryResult(h, `SELECT call31((a:=[(x:=1)])).a[0];`, [
      {
        x: 1,
      },
    ]);
  ...
  it("test_edgeql_calls_32", () => {
    ...
    assertQueryResult(h, `SELECT call32([1], [<int16>2]);`, [[1, 2]]);
  });
  ...
  it("test_edgeql_calls_33", () => {
    ...
    assertQueryResult(h, `SELECT call33((1, (2,)), (foo := 10, bar := 'bar'));`, [11]);
  });
  ...
  it("test_edgeql_calls_34", () => {
    ...
    assertQueryResult(h, `SELECT call34([(1, 2), (3, 4)]);`, [1]);
  });
  ...
  it("test_edgeql_calls_35a", () => {
    ...
    assertQueryResult(h, `SELECT call35(1);`, [
      [
        1,
        {
          foo: 2,
    ...
    assertQueryResult(h, `SELECT call35(1).1.foo;`, [2]);
  });
  ...
  it("test_edgeql_calls_35b", () => {
    ...
    assertQueryResult(h, `SELECT call35((1, [(2,)]));`, [
      [
        1,
        [
          {
    ...
    assertQueryResult(h, `SELECT call35((1, [(2,)])).1[0].foo;`, [2]);
  });
  ...
  it("test_edgeql_calls_36", () => {
    ...
    assertQueryResult(h, `SELECT call36(1);`, [[[1]]]);
  });
  ...
  it("test_edgeql_calls_37", () => {
    ...
    assertQueryResult(h, `SELECT call37();`, [3]);
    assertQueryResult(h, `SELECT call37(2);`, [4]);
    assertQueryResult(h, `SELECT call37(2, 3);`, [5]);
  });
  ...
  it("test_edgeql_calls_38", () => {
    ...
    assertQueryResult(h, `SELECT call38(C38);`, ["yay"]);
  });
  ...
  it("test_edgeql_calls_39", () => {
    ...
    assertQueryResult(h, `SELECT call39("identity");`, ["identity"]);
  });
  ...
  it("test_edgeql_calls_40", () => {
    ...
    assertQueryResult(h, `SELECT call40(Rectangle);`, [6]);
  });
  ...
  it("test_edgeql_calls_41", () => {
    ...
    assertQueryResult(h, `SELECT call41(1, 2);`, [1, 2]);
  });
  ...
  it("test_edgeql_calls_42", () => {
    ...
    assertQueryResult(h, `SELECT call42(1, 2);`, [
      [1, "1"],
      [2, "2"],
    ]);
    assertQueryResult(h, `SELECT call42(1, 2).0;`, [1, 2]);
  });
  ...
  it("test_edgeql_calls_obj_03", () => {
    ...
    h.script(`DROP FUNCTION fight(one: Person, two: Person)`);
    expect(() => {
      h.script(
        `
                WITH
  ...
  it("test_edgeql_calls_obj_05", () => {
    ...
    assertQueryResult(h, `SELECT boo((SELECT Ghost))`, ["oh my, Casper scared me!"]);
    expect(() => {
      h.script(`SELECT boo((UPDATE Ghost SET { name := 'Tom' }))`);
    }).toThrow(new RegExp("newly created or updated objects cannot be passed to functions"));
    expect(() => {
      h.script(`SELECT boo((INSERT Ghost { name := 'Jack' }));`);
    }).toThrow(new RegExp("newly created or updated objects cannot be passed to functions"));
    expect(() => {
      h.script(
        `
