...
| The selected object is a view type                     | The result type is `**derived**::default                                                                                                      | User@view~~1`, not plain `default::User`. The exact `view~~N` suffix is generated, but the view boundary is meaningful. |
...
| View type boundary             | Missing or collapsed    | Gel result type is `**derived**::default                                                                                                                                | User@view~1`; sqlite-ts reports `default::User`. |
