# SPEC-PARITY: EdgeQL (`edgeql/index.rst`)
...
Define one-for-one parity targets for `edgeql/index.rst` so sqlite-ts can match Gel's documented feature set.
...
- [ ] S1: `Design goals` parity is implemented and covered by tests.

## Requirements

- R1: sqlite-ts SHALL parse and/or execute constructs required by `edgeql/index.rst` with equivalent user-visible behavior.
...
- Upstream docs:
  - `docs/reference/edgeql/index.rst`
