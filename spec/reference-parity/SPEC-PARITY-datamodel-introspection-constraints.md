# SPEC-PARITY: Constraints (`datamodel/introspection/constraints.rst`)
...
Define one-for-one parity targets for `datamodel/introspection/constraints.rst` so sqlite-ts can match Gel's documented feature set.
...
- R1: sqlite-ts SHALL parse and/or execute constructs required by `datamodel/introspection/constraints.rst` with equivalent user-visible behavior.
...
- Upstream docs:
  - `docs/reference/datamodel/introspection/constraints.rst`
