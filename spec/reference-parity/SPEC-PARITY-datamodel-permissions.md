# SPEC-PARITY: Permissions (`datamodel/permissions.rst`)
...
Define one-for-one parity targets for `datamodel/permissions.rst` so sqlite-ts can match Gel's documented feature set.
...
- [ ] S1: `Built-in permissions` parity is implemented and covered by tests.
- [ ] S2: `Custom permissions` parity is implemented and covered by tests.
- [ ] S3: `Common patterns` parity is implemented and covered by tests.
- [ ] S4: `Public readonly database` parity is implemented and covered by tests.
- [ ] S5: `Public partially writable database` parity is implemented and covered by tests.
- [ ] S6: `Restricting branches` parity is implemented and covered by tests.
- [ ] S7: `Superuser permissions` parity is implemented and covered by tests.

## Requirements

- R1: sqlite-ts SHALL parse and/or execute constructs required by `datamodel/permissions.rst` with equivalent user-visible behavior.
...
- Upstream docs:
  - `docs/reference/datamodel/permissions.rst`
