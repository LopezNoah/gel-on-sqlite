# SPEC-PARITY: Future behavior (`datamodel/future.rst`)
...
Define one-for-one parity targets for `datamodel/future.rst` so sqlite-ts can match Gel's documented feature set.
...
- [ ] S1: `Flags` parity is implemented and covered by tests.
- [ ] S2: `Declaring future flags` parity is implemented and covered by tests.
- [ ] S3: `Syntax` parity is implemented and covered by tests.
- [ ] S4: `Description` parity is implemented and covered by tests.
- [ ] S5: `Example` parity is implemented and covered by tests.
- [ ] S6: `DDL commands` parity is implemented and covered by tests.
- [ ] S7: `Create future` parity is implemented and covered by tests.
- [ ] S8: `Drop future` parity is implemented and covered by tests.

## Requirements

- R1: sqlite-ts SHALL parse and/or execute constructs required by `datamodel/future.rst` with equivalent user-visible behavior.
...
- Upstream docs:
  - `docs/reference/datamodel/future.rst`
