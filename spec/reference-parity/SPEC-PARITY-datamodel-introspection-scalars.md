# SPEC-PARITY: Scalar types (`datamodel/introspection/scalars.rst`)
...
Define one-for-one parity targets for `datamodel/introspection/scalars.rst` so sqlite-ts can match Gel's documented feature set.
...
- R1: sqlite-ts SHALL parse and/or execute constructs required by `datamodel/introspection/scalars.rst` with equivalent user-visible behavior.
...
- Upstream docs:
  - `docs/reference/datamodel/introspection/scalars.rst`
