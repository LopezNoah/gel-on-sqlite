# SPEC-PARITY: Modules (`datamodel/modules.rst`)
...
Define one-for-one parity targets for `datamodel/modules.rst` so sqlite-ts can match Gel's documented feature set.
...
- [ ] S1: `Name resolution` parity is implemented and covered by tests.
- [ ] S2: `Reserved module names` parity is implemented and covered by tests.
- [ ] S3: `Modules are containers` parity is implemented and covered by tests.
- [ ] S4: `Nested modules` parity is implemented and covered by tests.
- [ ] S5: `Declaring modules` parity is implemented and covered by tests.
- [ ] S6: `Syntax` parity is implemented and covered by tests.
- [ ] S7: `Description` parity is implemented and covered by tests.
- [ ] S8: `DDL commands` parity is implemented and covered by tests.
- [ ] S9: `Create module` parity is implemented and covered by tests.
- [ ] S10: `Parameters` parity is implemented and covered by tests.
- [ ] S11: `Examples` parity is implemented and covered by tests.
- [ ] S12: `Drop module` parity is implemented and covered by tests.

## Requirements

- R1: sqlite-ts SHALL parse and/or execute constructs required by `datamodel/modules.rst` with equivalent user-visible behavior.
...
- Upstream docs:
  - `docs/reference/datamodel/modules.rst`
