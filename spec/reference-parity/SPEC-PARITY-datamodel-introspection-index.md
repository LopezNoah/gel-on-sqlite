# SPEC-PARITY: Introspection (`datamodel/introspection/index.rst`)
...
Define one-for-one parity targets for `datamodel/introspection/index.rst` so sqlite-ts can match Gel's documented feature set.
...
- R1: sqlite-ts SHALL parse and/or execute constructs required by `datamodel/introspection/index.rst` with equivalent user-visible behavior.
...
- Upstream docs:
  - `docs/reference/datamodel/introspection/index.rst`
