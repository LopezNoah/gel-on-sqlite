# SPEC-PARITY: Extensions (`datamodel/extensions.rst`)
...
Define one-for-one parity targets for `datamodel/extensions.rst` so sqlite-ts can match Gel's documented feature set.
...
- [ ] S1: `Built-in extensions` parity is implemented and covered by tests.
- [ ] S2: `Standalone extensions` parity is implemented and covered by tests.
- [ ] S3: `Using extensions` parity is implemented and covered by tests.
- [ ] S4: `Syntax` parity is implemented and covered by tests.
- [ ] S5: `DDL commands` parity is implemented and covered by tests.
- [ ] S6: `create extension` parity is implemented and covered by tests.
- [ ] S7: `Description` parity is implemented and covered by tests.
- [ ] S8: `Examples` parity is implemented and covered by tests.
- [ ] S9: `drop extension` parity is implemented and covered by tests.

## Requirements

- R1: sqlite-ts SHALL parse and/or execute constructs required by `datamodel/extensions.rst` with equivalent user-visible behavior.
