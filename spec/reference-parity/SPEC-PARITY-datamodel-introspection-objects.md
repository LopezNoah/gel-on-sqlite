# SPEC-PARITY: Object types (`datamodel/introspection/objects.rst`)
...
Define one-for-one parity targets for `datamodel/introspection/objects.rst` so sqlite-ts can match Gel's documented feature set.
...
- R1: sqlite-ts SHALL parse and/or execute constructs required by `datamodel/introspection/objects.rst` with equivalent user-visible behavior.
...
- Upstream docs:
  - `docs/reference/datamodel/introspection/objects.rst`
